...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/wallisonmoura',
  },
  {
    name: 'Linkedin',
    link: 'https://www.linkedin.com/in/wallison-moura/',
  },
];
        ...
        <div className="row">
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <h2>Em caso de contato...</h2>
              <P style={{ marginTop: 7, marginBottom: 0 }}>Onde me encontrar, através dos links.</P>
